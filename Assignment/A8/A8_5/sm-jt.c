...
//   }
  ...
  static const void* jtFInsOpCode[] = { &&F0x0, &&FDEFAULT, &&FDEFAULT, &&FDEFAULT, &&FDEFAULT, &&FDEFAULT, &&FDEFAULT, &&FDEFAULT, 
  &&FDEFAULT, &&FDEFAULT, &&FDEFAULT, &&F0xb, &&FDEFAULT, &&FDEFAULT, &&FDEFAULT, &&FDEFAULT };
  if (insOpCode < 0 || insOpCode > 0xf) goto FDEFAULT;
  goto *jtFInsOpCode [insOpCode];
F0x0: ;
F0xb: ;
  insOpExt = mem [pc] << 24 | mem [pc+1] << 16 | mem [pc+2] << 8 | mem [pc+3];
  pc += 4;
...
int exec() {
  ...
  if (insOpCode < 0 || insOpCode > 0xf) goto OPDEFAULT;
...
OP0x6: ;// ALU ................... 6-sd
    ...
    if (insOp0 < 0 || insOp0 > 0xf) goto DEFAULT;
...
OPCONT:
  ...
  //       // static const void* jt[2] = { &&L0x0, &&L0x1, &&L0x2, &&L0x3, &&L0x4, &&L0x5, &&L0x6, &&L0x7, 
  //       // &&L0x8, &&L0x9, &&L0xa, &&L0xb, &&L0xc, &&L0xd, &&L0xe, &&L0xf, &&DEFAULT };
